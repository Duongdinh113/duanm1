                        ...
                        <div class="my-[15px]">
                            <form action="./quanLi_user.php" method="POST">
                                <div class="flex gap-2">
                                    ...
                                    <div>
                                        <button
                                            class="p-1 border-[1px] border-[#38A169] h-[30px] rounded text-[white] font-bold bg-[#38A169]">Tìm kiêms</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <table class="w-[1000px] h-[200px]">
                            <thead>
                                <tr class="bg-[black] h-[50px]">
                                    ...
                                    <th class="text-[white]">bình luận
                                    <th class="text-[white]">Ngày tháng</th>
