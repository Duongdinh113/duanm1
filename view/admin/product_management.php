            ...
            <div class="border-r-[1px] border-[#CBD5E0]">
                ...
                <div class="flex mt-[24px] ml-[20px]">
                    ...
                    <a href="quanLi_user.php">
                        <p class="lg:ml-[10px] lg:font-normal lg:text-[#4A4A4A] lg:text-sm lg:mt-1">Quản lý người dùng</p>
                    </a>
                    ...
                    <div class="my-[15px]">
                        <form action="./product_management.php" method="POST">
                            <div class="flex gap-2">
                                ...
                                <div>
                                    <button
                                        class="border-[3px] border-[#38A169] p-1 rounded text-[white] font-bold bg-[#38A169]">Tìm kiếm</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <table class="w-[1000px] h-[200px]">
                        <thead>
                            <tr class="bg-[black] h-[50px]">
                                <th class="text-[white]">mã sản phẩm</th>
                                <th class="text-[white]">Tên sản phẩm</th>
                                <th class="text-[white]">mổ tả</th>
                        ...
                        <tbody>
                            ...
                            <a href="add_new.php"><button
                                    class="mb-[40px] mt-[10px] border-[1px] w-[200px] h-[30px] rounded-[10px] bg-[#38A169] text-[white] font-bold">Thêm sản phẩm</button></a>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="update.php?id=<?php echo $product["id"] ?>"><button
                                                class="border-[1px] rounded w-[60px] bg-[#1E74A4] text-[white]">cập nhật</button></a>
