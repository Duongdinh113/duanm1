...
<body class="max-w-full m-auto">
    ...
    <div>
        <div class="flex justify-between mx-[20px] mt-5">
            <div class="">
                <img src="../../viewND/image/anh1.1_1.png" alt="">
                            ...
                            <div class="my-[15px]">
                                <form action="./quanLi_user.php" method="POST">
                                    <div class="flex gap-2">
                                        ...
                                        <div>
                                            <button
                                                class="border-[1px] border-[#38A169] h-[30px] rounded text-[white] font-bold bg-[#38A169]">Tìm kiếm</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="../../control/control_xacNhandatHang.php" method="POST">
                                                    ...
                                                    <input type="text" hidden value="Hủy đơn hàng" name="huy" id="">
